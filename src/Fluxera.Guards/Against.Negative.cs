namespace Fluxera.Guards
{
	...
	public static class GuardAgainstNegativeExtensions
	{
		...
		public static T Negative<T>(this IGuard guard, T input, [InvokerParameterName] [CallerArgumentExpression("input")] string parameterName = null, string message = null)
			where T : INumber<T>
		{
